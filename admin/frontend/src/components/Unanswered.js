...
class Unanswered extends Component {
    ...
    getSuggestions = (input) =>{
        this.setState({questionDetails: input, display: false});
    }
            ...
            <div className="w3-container">
                {
                        ...
                        this.state.unansweredList.map(r => {
                            return (
                                <tr key={r.id}>
                                    ...
                                    <td><MDBBtn color="info" size="sm"
                                                onClick={() => this.getSuggestions(r.id)}> View</MDBBtn></td>
                                </tr>
                            )
                        })
                    }
                    ...
                    ) : (<Suggestions questionDetails={this.state.questionDetails} changeDisplay={()=>this.changeDisplay()}/>)
                }
